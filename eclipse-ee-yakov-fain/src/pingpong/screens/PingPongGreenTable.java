...
import pingpong.engine.PingPongGameEngine; 
...
public class PingPongGreenTable extends JPanel implements GameConstants{   
	...
	public void paintComponent(Graphics g) {   
	    ...
	    g.drawRect(TABLE_BORDER, TABLE_BORDER, TABLE_WIDTH - TABLE_BORDER*2, TABLE_HEIGHT - TABLE_BORDER*2); 
	    g.drawLine(TABLE_WIDTH/2, TABLE_BORDER, TABLE_WIDTH/2, TABLE_HEIGHT - TABLE_BORDER);
	...
	public static void main(String[] args) { 
		...
		f.setBounds(0,0,TABLE_WIDTH+15, TABLE_HEIGHT+60); 
		f.setVisible(true); 
	} 
}
